...
Let's add some lifetimes to get our program to compile:
...
So that's what I've managed to work out with regards to lifetime specifiers, it's taken a while to click and I still wouldn't class myself as proficient but I'm getting there! The main lesson I have learnt is that oftentimes it's a lot easier to stop, trace the references and work out their scopes and relationships, than it is to blindly start adding lifetime parameters based on where the compiler says there are errors. I hope you have found this post useful, until next time. 
