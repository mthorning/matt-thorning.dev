...
You can see that now the component can be used for any number of different uses, we could continue with the abstractions but and allow other input types but I think we'll move on! 
