...
I haven't spent a great deal of time with Go but I have built a Graphql server which serves the list of blog posts [here](/blog). I really enoyed using it so I'm looking forward to finding some more projects to work on in the future.
</TitledSection>
