...
I haven't spent a great deal of time with Go but I have built a Graphql server to serve the list of blog posts on this site. I really enoyed using it so I'm looking forward to finding some more projects to work on in the future.
</TitledSection>
